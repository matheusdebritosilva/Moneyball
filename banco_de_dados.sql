...
-- Já vem cadastrado assim que o banco é criado em qualquer máquina,
-- sem depender do api.php para criá-lo na primeira requisição.
-- Login: admin@2kstats.gg  |  Senha: admin123
-- A senha abaixo já está com hash bcrypt (mesmo formato do password_hash
-- do PHP), então password_verify() reconhece normalmente.
-- =====================================================================
INSERT INTO usuarios (nome, email, senha, perfil)
VALUES (
    'Administrador',
    'admin@2kstats.gg',
    '$2b$12$/HfbxaZlKi3ARbEeUXCx/eV5ER77RZ6Wy8qH0bnBYfmNjWOTAa61O',
    'Administrador'
)
